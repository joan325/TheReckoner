...
But criticism of the curriculum, while valid and necessary, is missing the forest for the trees. The problem with math education is _societal_, not pedagogical. Fundamentally, people—parents, students, even some teachers—misunderstand not only basic mathematical facts, but also the entire discipline of mathematics. Mathematics is not merely number crunching, or arithmetic exercises, or the repeated application of any kind of algorithm. Instead, it is an art, practiced for its own sake, as valid as painting or music or poetry.
